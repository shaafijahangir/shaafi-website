        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              <a
                href="#contact"
                className="bg-[hsl(var(--primary))] text-[hsl(var(--primary-foreground))] dark:bg-[#004266] rounded-full py-2 px-5 font-medium shadow-[6px_6px_20px_rgba(0,0,0,0.25)] hover:shadow-[8px_8px_24px_rgba(0,0,0,0.3)] active:translate-y-[1px] transition-all duration-200 flex items-center"
              >
                Get in Touch
              ...
              <a
                href="#projects"
                className="bg-[hsl(var(--alternate))] text-primary rounded-full py-2 px-5 font-medium shadow-[6px_6px_20px_rgba(0,0,0,0.25)] hover:shadow-[8px_8px_24px_rgba(0,0,0,0.3)] active:translate-y-[1px] transition-all duration-200"
              >
                View Projects
              </a>
